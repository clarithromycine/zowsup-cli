...
class IncomingReceiptProtocolEntity(ReceiptProtocolEntity):
    ...
    def __init__(self, _id, _from, timestamp, offline = None, type = None, participant = None, items = None) -> None:
        super().__init__(_id)
    ...
    def setIncomingData(self, _from, timestamp, offline, type = None, participant = None, items = None) -> Any:
        self._from = _from
