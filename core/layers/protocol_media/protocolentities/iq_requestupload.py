...
class RequestUploadIqProtocolEntity(IqProtocolEntity):
    ...
    def __init__(self, mediaType, b64Hash = None, size = None, origHash = None, filePath = None ) -> None:
    ...
    def setRequestArguments(self, mediaType, b64Hash, size, origHash = None) -> Any:
        assert mediaType in self.__class__.TYPES_MEDIA, f"Expected media type to be in {self.__class__.TYPES_MEDIA}, got {mediaType}"
