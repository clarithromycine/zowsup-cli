...
class ResultGetKeysIqProtocolEntity(ResultIqProtocolEntity):
    ...
    """
    def __init__(self, _id, preKeyBundleMap = None) -> None:
        super().__init__(_from = YowConstants.WHATSAPP_SERVER, _id=_id)
        self.setPreKeyBundleMap(preKeyBundleMap)
        self._errors = {}
        self.userActiveMap={}

    def getJids(self) -> Any:
        return self.preKeyBundleMap.keys()

    def getErrors(self) -> Any:
        return self._errors.copy()

    def setErrorFor(self, jid, exception) -> Any:
        self._errors[jid] = exception

    def setPreKeyBundleMap(self, preKeyBundleMap = None) -> Any:
        self.preKeyBundleMap = preKeyBundleMap or {}

    def setPreKeyBundleFor(self, jid, preKeyBundle) -> Any:
        self.preKeyBundleMap[jid] = preKeyBundle

    def getPreKeyBundleFor(self, jid) -> Any:
...
class MissingParametersException(Exception):
    ...
    def __init__(self, jid, parameters) -> None:
